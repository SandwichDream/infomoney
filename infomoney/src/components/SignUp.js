...
class SignUp extends React.Component {
    render() {
        return(<div className="app-modal-sign-up modal-fullscreen d-none">
            <div>
                <header className="d-flex justify-content-between mb-4">
                    <h5>Sign Up</h5>
                    <BiX className="bix" onClick={() => {
                        const inputs = document.querySelectorAll(".app-modal-sign-up main input");
                        ...
                        inputs[2].value = "";
                        inputs[2].placeholder = "repeat password";
                        inputs[2].classList.remove("red-placeholder");

                        document.querySelector(".app-modal-sign-up").classList.add("d-none");
                    }}/>
                </header>
                <main className="d-flex flex-column justify-content-center">
                    ...
                    <div className="input-group mb-3">
                        <input type="text" className="form-control" placeholder="repeat password" maxLength="32"/>
                    </div>
                </main>
                <footer className="d-flex justify-content-end">
                    <button className="btn" onClick={() => {
                        ...
                        const password1 = inputs[2];

                        let goodEmail = false;
                        let goodPassword0 = false;
                        let goodPassword1 = false;
                        ...
                        if (password1.value === password0.value) {
                            password1.placeholder = "repeat password";
                            password1.classList.remove("red-placeholder");
                            goodPassword1 = true;
                        }
                        else {
                            password1.placeholder = "Enter a correct password.";
                            password1.classList.add("red-placeholder");
                            password1.value = "";
                            goodPassword1 = false;
                        }

                        if (goodEmail && goodPassword0 && goodPassword1) {
                            document.querySelector(".app-modal-sign-up").classList.add("d-none");
                            email.value = "";
                            password0.value = "";
                            password1.value = "";
